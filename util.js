...
function time(){
	...
	var order = ["coffee1","pravesh",	"giulio",	"coffee2",	"omri",	"lunch",	"prashant",	"chris",	"coffee3",	"andrej",	"nobutaka", 	"dinner"];
	var times = [9, 		9.5, 		10.25, 		11, 		11.5, 	12.25, 		13.75, 		14.5, 		15.25,		15.75, 		16.5, 		 	20];
